...
#----------------------------------------------------------------------#
root_data_folder = r'E:/SCC_Project/scc_final_submission/pandanus_classification/msi_image_mask_rois/testing'
...
input_img_folder = os.path.join(root_data_folder, 'msi_rois')
input_mask_folder = os.path.join(root_data_folder, 'msi_mask_rois')
