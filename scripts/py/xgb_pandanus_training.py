...
root_data_folder = r'E:/SCC_Project/scc_final_submission'
root_image_folder = r'E:/SCC_Project/scc_final_submission/pandanus_classification/msi_image_mask_rois/training'
...
# Background_downsampled = resample(Background, replace=True, n_samples=len(blp), random_state=42)
...
classifier_XGB = xgb.XGBClassifier(random_state=42, learning_rate=0.01, n_jobs=-1)
